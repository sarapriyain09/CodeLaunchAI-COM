...
- [ ] Backend: `/patch` endpoint (update blueprint + regenerate touched files)
- [ ] Backend: incremental rebuild path when only a few files change
- [ ] Frontend: "Update app" chat flow + diff indicators for changed files
- [ ] Deliverable check: iterative edits work without wiping project

## Week 7 — Export, Pricing & Limits
- [ ] Backend: ZIP export endpoint + credit usage tracking + basic rate limits
- [ ] Frontend: download button, usage meter, upgrade CTA (Stripe test or placeholder)
- [ ] Deliverable check: users can export code and understand usage limits

## Week 8 — Polish, SEO & Launch Prep
- [ ] Product: landing page with SEO copy, value prop, examples gallery
- [ ] Engineering: error handling, empty states, performance tuning, guardrails
- [ ] Ops: deploy backend + frontend, domain + HTTPS, basic monitoring
- [ ] Deliverable check: public MVP ready for early adopters
